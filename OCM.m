...
function [var, cost] = OCM(param, Tin_ref, Tout, Tin0, Pf_ref, Pc_ref, Pil, theta, Eb0, D, M)
...
r_S = param.r_S(:,1); % power per unit of invested soalr capacity
c_S = param.c_S; % investment cost of solar power per kW

% I. Wind Energy Investment Input Parameters

r_W = param.r_W(:,1); % power per unit of invested wind capacity
